...
with open('/home/eli/Downloads/gmu work/runs/person/7_27_person/test_predictions_simple.txt', 'r') as f:
    content = f.read()
...
with open('/home/eli/Downloads/gmu work/runs/person/7_27_person/mistakes_predictions.txt', 'w') as f:
